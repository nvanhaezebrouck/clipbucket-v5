...
class MWIP extends \Migration
{
    ...
    public function start()
    {
        ...
        if (empty($results)) {
            $sql = 'INSERT IGNORE INTO `' . tbl('user_memberships_status') . '` (`language_key_title`)  VALUES (\'in_progress\'), (\'completed\'), (\'canceled\'), (\'refunded\'), (\'failed_authorized\'), (\'authorized\'), (\'failed_capture\')';
            self::query($sql);
        }
        ...
        /** Create paypal_transactions table with billing address columns */
        ...
        /** Create paypal_transactions_logs table */
        ...
        $sql = /** @lang MySQL */ 'CREATE TABLE IF NOT EXISTS `' . tbl('user_billing_address') . '` (
